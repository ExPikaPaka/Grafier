...
struct ExampleAppConsole
{
    ...
    ExampleAppConsole()
    {
        ...
        // "Application" is here to provide the test case where "C"+[tab] completes to "CL" and display multiple matches.
        Commands.push_back("HELP");
        Commands.push_back("HISTORY");
        Commands.push_back("CLEAR");
        Commands.push_back("Application");
        AutoScroll = true;
        ...
        case ImGuiInputTextFlags_CallbackCompletion:
            {
                ...
                else
                {
                    ...
                    // So inputting "C"+Tab will complete to "CL" then display "CLEAR" and "Application" as matches.
