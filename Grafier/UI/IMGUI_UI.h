    ...
    namespace ui {
        namespace imgui {
			...
			void SetupImGuiStyle() {
				...
				style.ScrollbarSize = 6.60000038146973f;
				...
				style.Colors[ImGuiCol_FrameBg] = ImVec4(0.1907843190431595f, 0.1790196138620377f, 0.2221568661928177f, 0.7811158895492554f);
			...
			void renderFrame(GLFWwindow* handle) {
				ImGui::Render();
