...
ent::render::Shader::Shader(const char* vertexShPath, const char* fragmentShPath) : Shader() {
	std::string vsp(vertexShPath);
	std::string fsp(fragmentShPath);
	load(vsp, fsp);
}

ent::render::Shader::Shader(std::string& vertexShPath, std::string& fragmentShPath) : Shader() {
...
bool ent::render::Shader::load(const char* vertexShPath, const char* fragmentShPath) {
	std::string vsp(vertexShPath);
	std::string fsp(fragmentShPath);
	return load(vsp, fsp);
}
